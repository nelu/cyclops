...
import {
  ...
  ContextSearchParams,
} from '../../../api/contexts/types';
import { AlertDataContextSelect } from '../components/AlertDataContextSelect';
import { JSONFormatter } from '../../../components/JSONFormatter';
import { AlertDataContextDetail } from '../components/AlertDataContextDetail';
...
const mapStateToProps: MapStateToProps<ValueProps, OwnProps> = (
  ...
  selectedContext: state.alert.context.selectedContext,
  page: state.alert.context.page,
  pageSize: state.alert.context.pageSize,
  loading: state.alert.context.loading,
  results: state.alert.context.results,
  resultCount: state.alert.context.resultCount,
