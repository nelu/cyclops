...
import { fetchAlertStatusDistribution } from '~/services/alerts/utils/alertsAPI';
...
export class AlertStatusDistributionStore {
  ...
  public fetchData = (days: number): Promise<void> => {
    ...
    return fetchAlertStatusDistribution(days)
      .then((distribution) => {
