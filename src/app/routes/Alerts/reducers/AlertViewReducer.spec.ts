...
// Local
import { AlertViewReducer } from './AlertViewReducer';
import * as actions from '../actions/AlertViewActions';
import { updateAlertSuccess } from '../../AlertDetail/actions/AlertDetailActions';

describe('AlertViewReducer', () => {
  ...
  describe('STOP_POLLING', () => {
    ...
    it('should call clearTimeout if there is a timeout on state', () => {
      ...
      AlertViewReducer(state as any, action);
  ...
  describe('UPDATE_ALERT_SUCCESS', () => {
    it('should return the original state if it can\'t find the id of the ' +
      ...
      const update = AlertViewReducer(state, action);
