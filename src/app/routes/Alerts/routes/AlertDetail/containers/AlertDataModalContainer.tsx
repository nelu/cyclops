...
/** Properties for the AlertDataModal. */
interface Props {
...
/** Wrapped container component for the AlertDataModal component. */
export const AlertDataModalContainer = inject(
  ...
  observer((props: Props) => (
    <AlertDataModal
      ...
      isActive={props.alertDetailStore!.isModalActive}
