...
import { AlertParamsDateTimeSelect } from '~/routes/Alerts/components/AlertParamsDateTimeSelect';
import { AlertParamsCategorySelect } from '~/routes/Alerts/components/AlertParamsCategorySelect';
 ...
 */
@observer
export class AlertParamsX extends React.Component<Props, State> {
