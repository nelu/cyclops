...
import { AlertListTable } from '~/routes/Alerts/components/AlertListTable';
import { Loading } from '~/components/Loading';
import { AlertDetailRouteComponent } from '../routes/AlertDetail';
...
interface Props extends RouteProps<AlertSearchParams> {
...
export class AlertView extends React.Component<Props, {}> {
  ...
  public updateQuery = (newParams: AlertSearchParams): void => {
    ...
    this.props.history.push({ pathname: this.props.match.url, query });
  };
    ...
    return (
      <FlexBox>
        ...
        <Route
          ...
          component={AlertDetailRouteComponent}
        />
