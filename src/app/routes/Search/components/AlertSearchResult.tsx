...
import { AlertDetailComment } from '~/routes/Alerts/routes/AlertDetail/components/AlertDetailComment';
import { AlertListItem } from '~/routes/Alerts/components/AlertListItem';
  ...
  public render() {
    ...
    return (
      <div className="search-alert-result__container">
        <table>
          <AlertListItem alert={this.props.alert} onClick={this.props.onClick} />
        </table>
        <div
          id={this.id}
