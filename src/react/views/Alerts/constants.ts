...
import { AlertOption } from '../../api/alerts/types';
...
/**
 * The display options of the outcome choices.
 * @type {Dictionary<AlertOption>}
 */
export const OUTCOME_OPTIONS: Dictionary<AlertOption> = {
  'completed': {
    name: 'Completed',
    value: 'completed',
  },
...
/**
 * The OUTCOME_OPTIONS in an array instead of an object.
 * @type {AlertOption[]}
 */
export const OUTCOME_OPTIONS_LIST: AlertOption[] = _.values(OUTCOME_OPTIONS);
