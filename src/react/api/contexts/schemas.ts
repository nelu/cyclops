...
/**
 * Normalized distillery object associated with a context.
 * @type {schema.Entity}
 */
const CONTEXT_DISTILLERY_SCHEMA = new schema.Entity('distilleries');
 ...
 * @type {schema.Entity}
 */
export const CONTEXT_SCHEMA: schema.Entity = new schema.Entity(
  'contexts',
  {
    filters: CONTEXT_FILTER_LIST_SCHEMA,
    primary_distillery: CONTEXT_DISTILLERY_SCHEMA,
    related_distillery: CONTEXT_DISTILLERY_SCHEMA,
  },
);
